	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">BookTheSlots</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Manage Vehicle Entries</div>
                        ...
                        <div class="col-md-12">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
									<label>Vehicle Entry Time</label>
                        ...
                        <?php } ?>
									...
									<button type="submit" class="btn btn-success" name="submit-in">Submit For Exit</button>
